...
Projeto desenvolvido durante o Curso de Desenvolvimento WEB, Turma 12, da [trybe](https://www.betrybe.com/), onde desenvolvi minhas habilidades em JavaScript, React.js, React Testing Library e Jest, na criação de testes para uma aplicação React.
